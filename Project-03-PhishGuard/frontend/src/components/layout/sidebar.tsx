...
const NAV_ITEMS = [
  ...
  { to: "/analyzer", label: "Email Analyzer", icon: ScanSearch },
    ...
    <aside className="hidden w-64 shrink-0 flex-col border-r border-border bg-card/60 md:flex">
      <div className="flex h-16 items-center gap-2 border-b border-border px-5">
        ...
        <div className="leading-tight">
          <p className="text-sm font-bold tracking-tight">PhishGuard</p>
          <p className="text-[11px] text-muted-foreground">SOC Email Defense</p>
        </div>
      </div>
